...
max_pooled_scores = torch.load('maxpooledScores.t7')
--[[
max_pooled_scores = torch.Tensor(4952, 20)
for i=1,4952 do
	for j=1,20 do
...
true_scores = true_scores2.outmat
--[[
...
--[[
true_scores = torch.Tensor(4952, 20)
for i=1,4952 do
	for j=1,20 do
...
max_pooled_scores_modified_1 = torch.Tensor(4952, 20)
for i=1,4952 do
	for j=1,20 do
...
err = torch.zeros(4952,1) -- error for each image
...
err_min = torch.zeros(4952,1) -- error for each image
...
max_pooled_scores_modified_3 = torch.Tensor(4952, 20)
for i=1,4952 do
	for j=1,20 do
...
max_pooled_scores_modified_2 = torch.zeros(4952, 20)
